...
/*static struct attribute_group subsys_attrs[] = {
	__ATTR_RO(name),
	__ATTR_RO(state),
...
static DEVICE_ATTR(restart_level, 0644, restart_level_show, restart_level_store);
static DEVICE_ATTR(firmware_name, 0644, firmware_name_show, firmware_name_store);
static DEVICE_ATTR(system_debug, 0644, system_debug_show, system_debug_store);
